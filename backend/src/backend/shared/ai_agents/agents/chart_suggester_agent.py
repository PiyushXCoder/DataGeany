...
def agent():
    ...
    return Agent(
        ...
        Based on the user's request, suggest the most appropriate chart type from (Area Chart, Bar Chart, Bubble Chart, Doughnut and Pie Charts, Line Chart, Polar Area Chart, Radar Chart, Scatter Chart) to visualize the data effectively.
